...
The launcher changelog has moved to the centralised changelog repository.

Read it at: <https://github.com/DyingStar-game/changelog/blob/main/launcher/CHANGELOG.md>
